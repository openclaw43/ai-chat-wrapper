...
router.post('/api/chat', async (req: Request, res: Response) => {
  ...
  try {
    ...
    dbQueries.createMessage.run(conversationId, 'user', message);

    const existingMessages = dbQueries.getMessages.all(conversationId);
    ...
    try {
      ...
      dbQueries.createMessage.run(conversationId, 'assistant', assistantMessage);
